    ...
    <SectionWrapper id="about">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mt-4 text-slate-600">I am a Full Stack Developer passionate about building clean, 
          functional, and user-focused web applications. I enjoy transformin ideas into digital experiences
          ...
          enable me to create scalableand maintainable applications. I pay close attention to both the visual
           details users interact with and the underlying systems that power those experiences.
           Beyond writin code, I am committed to continuous learning and improving my craft. I approach every
           project with curiosity, problem-solving, and a desire to build solutions that create real value.
           Whether workin independently or collaborating with others, I strive to deliver products that are efficient,
           accessible, and thouhtfully desined.
